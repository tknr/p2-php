...
class SettingTxt
{
    ...
    public function __construct($host, $bbs)
    {
        ...
        //$this->_url = P2BbsType::adjustHostJbbs($this->_url); // したらばのlivedoor移転に対応。読込先をlivedoorとする。
    ...
    public function downloadSettingTxt()
    {
        ...
        if (P2BbsType::isHostMachiBbs($this->_host) || P2BbsType::isHostJbbsShitaraba($this->_host)) {
            return false;
        }
